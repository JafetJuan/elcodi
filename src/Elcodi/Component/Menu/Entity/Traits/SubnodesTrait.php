...
namespace Elcodi\Component\Menu\Entity\Traits;
...
trait SubnodesTrait
{
     ...
     * Add subnode.
     *
     * @param \Elcodi\Component\Menu\Entity\Interfaces\NodeInterface $node Node
     *
     * @return $this Self object
     */
    public function addSubnode(\Elcodi\Component\Menu\Entity\Interfaces\NodeInterface $node)
    {
        if ($node !== $this) {
     ...
     * @return $this Self object
     */
    public function removeSubnode(\Elcodi\Component\Menu\Entity\Interfaces\NodeInterface $node)
    {
    ...
    public function getSubnodesByTag($tag)
    {
        return $this
            ->getSubnodes()
            ->filter(function (\Elcodi\Component\Menu\Entity\Interfaces\NodeInterface $menuNode) use ($tag) {
     ...
     *
     * @return \Elcodi\Component\Menu\Entity\Interfaces\NodeInterface|null Node
     */
    public function findSubnodeByName($subnodeName, $inDepth = true)
    {
        ...
        /**
         * @var \Elcodi\Component\Menu\Entity\Interfaces\NodeInterface $subnode
         */
        foreach ($subnodes as $subnode) {
            ...
            if ($inDepth) {
                ...
                if ($subnode instanceof \Elcodi\Component\Menu\Entity\Interfaces\NodeInterface) {
                    return $subnode;
                }
            }
        }
