...
namespace Elcodi\Bundle\ZoneBundle\Mapping;

use Mmoreram\BaseBundle\Mapping\MappingBagCollection;
use Mmoreram\BaseBundle\Mapping\MappingBagProvider;

/**
 * Class ElcodiZoneMappingBagProvider.
 */
class ElcodiZoneMappingBagProvider implements MappingBagProvider
{
    /**
