...
namespace Elcodi\Bundle\EntityTranslatorBundle\Mapping;

use Mmoreram\BaseBundle\Mapping\MappingBagCollection;
use Mmoreram\BaseBundle\Mapping\MappingBagProvider;

/**
 * Class ElcodiTranslatorMappingBagProvider.
 */
class ElcodiTranslatorMappingBagProvider implements MappingBagProvider
{
    /**
    ...
    public function getMappingBagCollection() : MappingBagCollection
    {
        return MappingBagCollection::create(
            ...
            '@ElcodiEntityTranslatorBundle',
            'Elcodi\Component\EntityTranslator\Entity',
            'elcodi',
            'default',
            'object_manager',
            'repository',
