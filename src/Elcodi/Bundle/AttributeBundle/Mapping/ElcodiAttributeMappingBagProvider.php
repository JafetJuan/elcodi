...
namespace Elcodi\Bundle\AttributeBundle\Mapping;

use Mmoreram\BaseBundle\Mapping\MappingBagCollection;
use Mmoreram\BaseBundle\Mapping\MappingBagProvider;

/**
 * Class ElcodiAttributeMappingBagProvider.
 */
class ElcodiAttributeMappingBagProvider implements MappingBagProvider
{
    /**
    ...
    public function getMappingBagCollection() : MappingBagCollection
    {
        return MappingBagCollection::create(
            ...
            'Elcodi\Component\Attribute\Entity',
            'elcodi',
            'default',
            'object_manager',
            'repository',
