...
namespace Elcodi\Bundle\CartBundle\Mapping;

use Mmoreram\BaseBundle\Mapping\MappingBagCollection;
use Mmoreram\BaseBundle\Mapping\MappingBagProvider;

/**
 * Class ElcodiCartMappingBagProvider.
 */
class ElcodiCartMappingBagProvider implements MappingBagProvider
{
    /**
